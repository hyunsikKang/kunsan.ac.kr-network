package kr.ac.kunsan.network.filetransfer._2.nio.socket.blocking.fileio.server;
...
public class ServerReceiveSocketHandler extends Thread {
	...
	public void run() {
		try {
			...
			try (SeekableByteChannel seekableByteChannel = Files.newByteChannel(Paths.get(savePath), StandardOpenOption.WRITE, StandardOpenOption.CREATE_NEW)) {
